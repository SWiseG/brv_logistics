define(`/static/js/modules/verify.reset.code.js`, `/static/js/mixins/mixin.dom.helper.js`, 
    function VerifyResetCode() {
        return {
            ...
            verificationCode: bindings.observable(null),
            resendTimer: bindings.observable(60),
            resendCodeURL: bindings.observable(null),
            resendInterval: null,
            compositionComplete: (name, path, dependencies, callback, params) => {
                ...
                ctor.resendCodeURL(
                    $('script[module="data-url"][type="resend-code"]').attr('data-url-bind')
                );
                ctor.startBindings();
